...
WHERE   BYAS.ActivityStatus = 1
        ...
        {
            var sqlText = @"SELECT Id,ActivityNum,ActivityName,ActivityStatus,CheckStatus,LayerImage,CouponId,ButtonChar,CreateTime,UpdateTime,ActivityImage,GetRuleGUID,Type FROM [Configuration].[dbo].[SE_CouponActivityConfig] WITH(NOLOCK)
                            WHERE ActivityStatus = 1 AND Type=@type AND  ActivityNum=@activityNum ";
            using (var cmd = new SqlCommand(sqlText))
            {
                cmd.Parameters.AddWithValue("type", type);
                cmd.Parameters.AddWithValue("@activityNum", activityNum);
                return await DbHelper.ExecuteFetchAsync<CouponActivityConfigModel>(true, cmd);
            }
        }
...
ON atp.ActivityId = sb.a
     ...
     WHEN NOT MATCHED THEN 
        ...
        {
            const string sql = @"SELECT  ActivityId , ProductId , AdvertiseTitle , SpecialCondition , IsCancelProgressBar FROM Configuration..RegionMarketingProductConfig WITH (NOLOCK) WHERE ActivityId=@ActivityId";
...
ORDER BY act.CreateDateTIme DESC";
        ...
        {
            const string sql = @"SELECT TOP 1 rapc.PKID,rapc.BackgroundImg,rapc.ActivityRules FROM Activity..RebateApplyPageConfig AS rapc WITH (NOLOCK) ORDER BY PKID DESC";
            using (var cmd = new SqlCommand(sql))
            {
                cmd.CommandType = CommandType.Text;
        ...
        public static async Task<List<RebateApplyConfigModel>> SelectRebateApplyConfigByParamV2(BaseDbHelper helper, RebateApplyRequest request)
        {
            const string sql = @"
                SELECT  rac.OrderId ,
                        rac.UserPhone ,
        ...
        public static async Task<int> InsertRebateApplyRecordV2(BaseDbHelper helper, RebateApplyRequest request, string source)
        {
            const string sql = @"
...
";
        ...
        /// </summary>
        /// <returns></returns>
        public static async Task<ActivityCouponModel> GetActivityCouponByUserId(Guid userId, long activityId)
        {
            var sql = @" SELECT [PKID]
                              ,[ActivityId]
                              ,[UserId]
        ...
        /// </summary>
        /// <returns></returns>
        public static async Task<IEnumerable<ActivityPrizeOrderDetailModel>> SearchPrizeOrderDetailID(Guid userId, long activityId)
        {
            var sql = @"
                            SELECT [PKID]
                                  ,[ActivityPrizeId]
...
=======
        public static async Task<long> ModifyActivityCoupon(BaseDbHelper helper, Guid userId, long activityId, int couponCount)
>>>>>>> cef10ecfe95a62dbe27086896d29d0abab5da3d4
        ...
        /// </summary>
        /// <returns></returns>
        public static async Task<Tuple<IEnumerable<ActivityNewModel>, int>> GetActivityModelsPagedAsync(int pageIndex, int pageSize)
        {
            string sql = @"
...
SELECT PKID,
    ...
    ROWS ONLY";
            using (var cmd = new SqlCommand(sql))
            {
                ...
                var result = await DbHelper.ExecuteSelectAsync<ActivityNewModel>(cmd);
                return new Tuple<IEnumerable<ActivityNewModel>, int>(result, (int)sqlParameters[2].Value);
            }
        }
        ...
        /// <param name="activityId"></param>
        /// <returns></returns>
        public static async Task<ActivityNewModel> GetActivityModelByActivityIdAsync(Guid activityId)
        {
            ...
            using (var cmd = new SqlCommand(sql))
            {
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.AddWithValue("@ActivityId", activityId);
                return await DbHelper.ExecuteFetchAsync<ActivityNewModel>(true, cmd);
            }
        }
        ...
        /// <returns></returns>
        public static async Task<int> InsertActivityModelAsync(ActivityNewModel activityModel)
        {
        ...
        /// <param name="activityModel"></param>
        /// <returns></returns>
        public static async Task<int> UpdateActivityModelAsync(ActivityNewModel activityModel)
        {
        ...
        /// <param name="activityId"></param>
        /// <returns></returns>
        public static async Task<bool> DeleteActivityModelByActivityIdAsync(Guid activityId)
        {
        ...
        /// <returns></returns>
        public static async Task<bool> InsertUserActivityModelAsync(UserApplyActivityModel userActivityModel)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static async Task<bool> UpdateUserActivityStatusByPKIDAsync(UserApplyActivityModel userActivityModel)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static async Task<Tuple<IEnumerable<UserApplyActivityModel>, int>> GetUserApplyActivityModelsPagedAsync(Guid activityId, AuditStatus auditStatus, int pageIndex, int pageSize)
        {
...
ORDER BY CreatedDateTime DESC
            ...
            using (var cmd = new SqlCommand(sql))
            {
                ...
                cmd.Parameters.AddRange(sqlParameters);
                var result = await DbHelper.ExecuteSelectAsync<UserApplyActivityModel>(cmd);
                return new Tuple<IEnumerable<UserApplyActivityModel>, int>(result, (int)sqlParameters[3].Value);
            }
        }
        /// <summary>
        /// 根据活动id获取报名人员数量
...
WHERE ActivityId = @ActivityId";
            using (var cmd = new SqlCommand(sql))
            {
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.Add(new SqlParameter("@ActivityId", activityId));
                return (int)await DbHelper.ExecuteScalarAsync(true, cmd);
            }
        }
        /// <summary>
        /// 根据活动id获取报名人员审核通过数量
...
WHERE ActivityId = @ActivityId AND Status = 1";
        ...
        /// <param name="pkid"></param>
        /// <returns></returns>
        public static async Task<UserApplyActivityModel> GetUserApplyActivityByPKIDAsync(int pkid)
        {
            string sql = @"SELECT TOP 1
       PKID,
       UserId,
...
WHERE PKID = @PKID";
            using (var cmd = new SqlCommand(sql))
            {
                ...
                return await DbHelper.ExecuteFetchAsync<UserApplyActivityModel>(true, cmd);
            }
        }
        /// <summary>
        /// 删除用户报名
        ...
        /// <param name="pkid"></param>
        /// <returns></returns>
        public static async Task<bool> DeleteUserApplyActivityModelByPKIDAsync(int pkid)
        {
        ...
        /// <returns></returns>
        public static async Task<bool> CheckUserApplyActivityInfoIsExistAsync(Guid activityId, string mobile, string carNum, string driverNum)
        {
            string sql = @"SELECT COUNT(1)
FROM Activity..T_UserApplyActivity WITH (NOLOCK)
WHERE ActivityId = @ActivityId And (Mobile = @Mobile
      OR CarNum = @CarNum
      OR DriverNum = @DriverNum)";
            using (var cmd = new SqlCommand(sql))
            {
                ...
                cmd.Parameters.AddRange(sqlParameters);
                return (int)await DbHelper.ExecuteScalarAsync(true, cmd) > 0;
            }
        }
        #endregion
    }
