...
namespace Tuhu.Provisioning.Controllers
{
    public class BaoyangController : Controller
    {
        ...
        public ActionResult BaoYangRecommendProductsSetIndex()
        {
            ...
            model.SkuItems = new Dictionary<string, Tuple<string, bool>>();
            model.BrandItems = new Dictionary<string, Tuple<string, bool>>();
            model.BrandPriceItems = new Dictionary<string, Tuple<string, bool>>();
            ...
            if (config != null && config.Sku != null)
            {
                ...
                {
                    model.SkuItems.Add(item.Category,
            ...
            if (config != null && config.Brand != null)
            {
                ...
                {
                    model.BrandItems.Add(item.Category,
                        Tuple.Create(item.Name,
            ...
            if (config != null && config.BrandPrice != null)
            {
                ...
                {
                    model.BrandPriceItems.Add(item.Category,
                        Tuple.Create(item.Name,
