...
[Obsolete("请使用GetRegionVehicleIdActivityUrlNewAsync")]
		...
		///<summary>分页获取报名参加活动的用户列表</summary>
        [OperationContract(Action = TuhuSerivce.TuhuSerivceNamespace + "/Activity/Activity/GetUserRegistrationsByArea", ReplyAction = TuhuSerivce.TuhuSerivceNamespace + "/Activity/Activity/GetUserRegistrationsByAreaResponse")]
        Task<OperationResult<PagedModel<UserRegistrationResponse>>> GetUserRegistrationsByAreaAsync(string area,int pageSize=20,int pageIndex=1);
		///<summary>获取用户活动列表</summary>
        [OperationContract(Action = TuhuSerivce.TuhuSerivceNamespace + "/Activity/Activity/GetUserActivities", ReplyAction = TuhuSerivce.TuhuSerivceNamespace + "/Activity/Activity/GetUserActivitiesResponse")]
        Task<OperationResult<List<UserActivityResponse>>> GetUserActivitiesAsync();
		///<summary>获取用户报名信息</summary>
        [OperationContract(Action = TuhuSerivce.TuhuSerivceNamespace + "/Activity/Activity/GetUserRegistrationById", ReplyAction = TuhuSerivce.TuhuSerivceNamespace + "/Activity/Activity/GetUserRegistrationByIdResponse")]
        Task<OperationResult<UserRegistrationResponse>> GetUserRegistrationByIdAsync(long pkid);
		///<summary>新增用户报名信息</summary>
        [OperationContract(Action = TuhuSerivce.TuhuSerivceNamespace + "/Activity/Activity/AddUserRegistration", ReplyAction = TuhuSerivce.TuhuSerivceNamespace + "/Activity/Activity/AddUserRegistrationResponse")]
        Task<OperationResult<bool>> AddUserRegistrationAsync(UserRegistrationRequest request);
		///<summary>修改用户报名信息</summary>
        [OperationContract(Action = TuhuSerivce.TuhuSerivceNamespace + "/Activity/Activity/ModifyUserRegistration", ReplyAction = TuhuSerivce.TuhuSerivceNamespace + "/Activity/Activity/ModifyUserRegistrationResponse")]
        Task<OperationResult<bool>> ModifyUserRegistrationAsync(UserRegistrationRequest request);
		///<summary>更新用户报名状态</summary>
        [OperationContract(Action = TuhuSerivce.TuhuSerivceNamespace + "/Activity/Activity/UpdateUserRegistrationStatus", ReplyAction = TuhuSerivce.TuhuSerivceNamespace + "/Activity/Activity/UpdateUserRegistrationStatusResponse")]
        Task<OperationResult<bool>> UpdateUserRegistrationStatusAsync(string area,RegistrationStatus status);
	}
...
[Obsolete("请使用GetRegionVehicleIdActivityUrlNewAsync")]
		...
		///<summary>分页获取报名参加活动的用户列表</summary>
        [OperationContract(Action = TuhuSerivce.TuhuSerivceNamespace + "/Activity/Activity/GetUserRegistrationsByArea", ReplyAction = TuhuSerivce.TuhuSerivceNamespace + "/Activity/Activity/GetUserRegistrationsByAreaResponse")]
        OperationResult<PagedModel<UserRegistrationResponse>> GetUserRegistrationsByArea(string area,int pageSize=20,int pageIndex=1);
		///<summary>获取用户活动列表</summary>
        [OperationContract(Action = TuhuSerivce.TuhuSerivceNamespace + "/Activity/Activity/GetUserActivities", ReplyAction = TuhuSerivce.TuhuSerivceNamespace + "/Activity/Activity/GetUserActivitiesResponse")]
        OperationResult<List<UserActivityResponse>> GetUserActivities();
		///<summary>获取用户报名信息</summary>
        [OperationContract(Action = TuhuSerivce.TuhuSerivceNamespace + "/Activity/Activity/GetUserRegistrationById", ReplyAction = TuhuSerivce.TuhuSerivceNamespace + "/Activity/Activity/GetUserRegistrationByIdResponse")]
        OperationResult<UserRegistrationResponse> GetUserRegistrationById(long pkid);
		///<summary>新增用户报名信息</summary>
        [OperationContract(Action = TuhuSerivce.TuhuSerivceNamespace + "/Activity/Activity/AddUserRegistration", ReplyAction = TuhuSerivce.TuhuSerivceNamespace + "/Activity/Activity/AddUserRegistrationResponse")]
        OperationResult<bool> AddUserRegistration(UserRegistrationRequest request);
		///<summary>修改用户报名信息</summary>
        [OperationContract(Action = TuhuSerivce.TuhuSerivceNamespace + "/Activity/Activity/ModifyUserRegistration", ReplyAction = TuhuSerivce.TuhuSerivceNamespace + "/Activity/Activity/ModifyUserRegistrationResponse")]
        OperationResult<bool> ModifyUserRegistration(UserRegistrationRequest request);
		///<summary>更新用户报名状态</summary>
        [OperationContract(Action = TuhuSerivce.TuhuSerivceNamespace + "/Activity/Activity/UpdateUserRegistrationStatus", ReplyAction = TuhuSerivce.TuhuSerivceNamespace + "/Activity/Activity/UpdateUserRegistrationStatusResponse")]
        OperationResult<bool> UpdateUserRegistrationStatus(string area,RegistrationStatus status);
	}
...
[Obsolete("请使用GetRegionVehicleIdActivityUrlNewAsync")]
	...
	///<summary>获取蓄电池/加油卡活动配置</summary>///<returns></returns>
		...
		///<summary>分页获取报名参加活动的用户列表</summary>
        public OperationResult<PagedModel<UserRegistrationResponse>> GetUserRegistrationsByArea(string area,int pageSize=20,int pageIndex=1) => Invoke(_ => _.GetUserRegistrationsByArea(area,pageSize,pageIndex));

	///<summary>分页获取报名参加活动的用户列表</summary>
        public Task<OperationResult<PagedModel<UserRegistrationResponse>>> GetUserRegistrationsByAreaAsync(string area,int pageSize=20,int pageIndex=1) => InvokeAsync(_ => _.GetUserRegistrationsByAreaAsync(area,pageSize,pageIndex));
		///<summary>获取用户活动列表</summary>
        public OperationResult<List<UserActivityResponse>> GetUserActivities() => Invoke(_ => _.GetUserActivities());

	///<summary>获取用户活动列表</summary>
        public Task<OperationResult<List<UserActivityResponse>>> GetUserActivitiesAsync() => InvokeAsync(_ => _.GetUserActivitiesAsync());
		///<summary>获取用户报名信息</summary>
        public OperationResult<UserRegistrationResponse> GetUserRegistrationById(long pkid) => Invoke(_ => _.GetUserRegistrationById(pkid));

	///<summary>获取用户报名信息</summary>
        public Task<OperationResult<UserRegistrationResponse>> GetUserRegistrationByIdAsync(long pkid) => InvokeAsync(_ => _.GetUserRegistrationByIdAsync(pkid));
		///<summary>新增用户报名信息</summary>
        public OperationResult<bool> AddUserRegistration(UserRegistrationRequest request) => Invoke(_ => _.AddUserRegistration(request));

	///<summary>新增用户报名信息</summary>
        public Task<OperationResult<bool>> AddUserRegistrationAsync(UserRegistrationRequest request) => InvokeAsync(_ => _.AddUserRegistrationAsync(request));
		///<summary>修改用户报名信息</summary>
        public OperationResult<bool> ModifyUserRegistration(UserRegistrationRequest request) => Invoke(_ => _.ModifyUserRegistration(request));

	///<summary>修改用户报名信息</summary>
        public Task<OperationResult<bool>> ModifyUserRegistrationAsync(UserRegistrationRequest request) => InvokeAsync(_ => _.ModifyUserRegistrationAsync(request));
		///<summary>更新用户报名状态</summary>
        public OperationResult<bool> UpdateUserRegistrationStatus(string area,RegistrationStatus status) => Invoke(_ => _.UpdateUserRegistrationStatus(area,status));

	///<summary>更新用户报名状态</summary>
        public Task<OperationResult<bool>> UpdateUserRegistrationStatusAsync(string area,RegistrationStatus status) => InvokeAsync(_ => _.UpdateUserRegistrationStatusAsync(area,status));
	}
