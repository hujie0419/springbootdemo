...
namespace Tuhu.C.YunYing.WinService.PushJobSchedulerService
{
    public partial class QuartzService : MasterSlaveService
    {
        ...
        public override void StartService()
        {
            ...
            if (ConfigurationManager.AppSettings["RunJob"] == "true") // 环境判断
            {

                _scheduler = new StdSchedulerFactory().GetScheduler();

                var uri = ConfigurationManager.AppSettings["CrystalQuartzUrl"] ?? "http://*:5557";
