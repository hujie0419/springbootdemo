...
namespace Tuhu.C.ActivityJob
{
    public partial class QuartzService : MasterSlaveService
    {
        ...
        public QuartzService():base("Tuhu.mkt.Activity.Job")
        {
            InitializeComponent();
        ...
        public override void StartService()
        {
            ...
            if (ConfigurationManager.AppSettings["RunJob"] == "false") // 环境判断
            {

                _scheduler = new StdSchedulerFactory().GetScheduler();

                var uri = ConfigurationManager.AppSettings["CrystalQuartzUrl"] ?? "http://*:5678";
