...
[Obsolete("请使用GetRegionVehicleIdActivityUrlNewAsync")]
		...
		/// <summary>/// 新增报名信息/// </summary>/// <param name='infomodel'></param>/// <returns></returns>
		...
		/// <summary>/// 修改报名信息/// </summary>/// <param name='infomodel'></param>/// <returns></returns>
		...
		///<summary>/// 上海市闵行区用户的报名状态为已通过/// </summary>/// <param name='area'></param>/// <returns></returns>
		...
		/// <summary>/// 根据区域条件查询用户分页信息/// </summary>/// <param name='area'></param>/// <param name='pageIndex'></param>/// <param name='pageSize'></param>/// <returns></returns>
		...
		/// <summary>/// 根据id获取model/// </summary>/// <param name='id'></param>/// <returns></returns>
		...
		/// <summary>/// 根据手机号获取model/// </summary>/// <param name='tel'></param>/// <returns></returns>
