...
namespace Tuhu.Service.Activity.Server.Manager
{
    public static class DiscountActivityInfoManager
    {
        ...
        /// <returns></returns>
        public static async Task<OperationResult<IEnumerable<ProductActivityInfoForTag>>> GetActivityAuditStatusAsync(List<string> pidList, DateTime startTime, DateTime endTime)
        {
