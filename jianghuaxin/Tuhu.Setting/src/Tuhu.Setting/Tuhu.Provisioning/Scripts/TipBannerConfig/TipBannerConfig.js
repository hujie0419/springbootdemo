...
function Delete(self) {
    var $self = $(self);
    var pkid = $self.parent().prevAll().eq(10).html();
    if (pkid < 1) {
        return;
    }
...
function Edit(self) {
    ...
    var pkid = $self.parent().prevAll().eq(10).html() || -1;
    var typeId = $self.parent().prevAll().eq(9).find("span").html() || -1;
    var isEnabled = $self.parent().prevAll().eq(8).find("span").html() || false;
    var icon = $self.parent().prevAll().eq(7).find("span").html() || "";
