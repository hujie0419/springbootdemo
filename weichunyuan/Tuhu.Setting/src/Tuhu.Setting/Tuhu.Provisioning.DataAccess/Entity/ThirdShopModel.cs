...
namespace Tuhu.Provisioning.DataAccess.Entity
{
    ...
    public class ProductListRequest
    {
        ...
        public string LowestPriceStatus { get; set; }
        public string CouponPriceStatus { get; set; }
        public string CanUseCouponStatus { get; set; }

        public string LowestPriceValue { get; set; }
        public string CouponPriceValue { get; set; }
    ...
    public class ProductPriceModel
    {
        ...
        /// 最低面价(平时)
        /// </summary>
        public decimal? LowestPrice_Normal { get; set; }
        /// <summary>
        /// 最低面价(大促)
        /// </summary>
        public decimal? LowestPrice_Promotion { get; set; }
        /// <summary>
        /// 券后价(平时)
        /// </summary>
        public decimal? CouponPrice_Normal { get; set; }
        /// <summary>
        /// 券后价(大促)
        /// </summary>
        public decimal? CouponPrice_Promotion { get; set; }

        public List<decimal?> NormalPrices
        {
            get
            {
                return new List<decimal?>()
                {
                    ...
                    TM4Price,
                    JDPrice,
                    JDFlagShipLowestPrice
                };
            }
        }

        public List<decimal?> LowestPrices
        {
            get
            {
                return new List<decimal?>()
