...
namespace Tuhu.Service.Activity.UnitTest
{
    ...
    public class ActivityUnitTest
    {
        ...
        /// </summary>
        [TestMethod]
        public void GetExceptionalCustomerOrderInfoTest()
        {
            using (var client = new ActivityClient())
            {
                var result = client.GetExceptionalCustomerOrderInfo();
        ...
        public void ActivityTestMethod()
        {
            using (var client = new ActivityClient())
            {
                var result = client.ActivityTestMethod(1635525);
                Assert.IsNotNull(result.Result);
            }
        }
        ...
        /// </summary>
        [TestMethod]
        public void TestAddRegistrationOfActivitiesData()
        {
            using (var client = new ActivityClient())
            {
                var model = new RegistrationOfActivitiesRequest();
                model.UserName = "小明";
                model.ClientIp = "129.9.9.2";
                model.Phone = "15622227777";
                model.ApplicationReasons = "想参加";
                var pictures = new List<string>();
                pictures.Add("https://img3.tuhu.org/ThirdParty/WXQcode/2cd3/31a9/8401647c4c808e0db06cb44c_w320_h320.jpeg?imageView2/2/format/jpg/q/100");
                pictures.Add("https://img3.tuhu.org/ThirdParty/WXQcode/2cd3/31a9/8401647c4c808e0db06cb44c_w320_h320.jpeg?imageView2/2/format/jpg/q/100");
                pictures.Add("https://img3.tuhu.org/ThirdParty/WXQcode/2cd3/31a9/8401647c4c808e0db06cb44c_w320_h320.jpeg?imageView2/2/format/jpg/q/100");
                pictures.Add("https://img3.tuhu.org/ThirdParty/WXQcode/2cd3/31a9/8401647c4c808e0db06cb44c_w320_h320.jpeg?imageView2/2/format/jpg/q/100");
                pictures.Add("https://img3.tuhu.org/ThirdParty/WXQcode/2cd3/31a9/8401647c4c808e0db06cb44c_w320_h320.jpeg?imageView2/2/format/jpg/q/100");
                model.Pictures = pictures;
                model.UserId = new Guid("fd48821b-b92b-4e4d-a913-1f67f4af276d");

                var result = client.AddRegistrationOfActivitiesData(model);
                Assert.IsNotNull(result.Result);
            }
        }
        #endregion
