!function () {
    ...
    domainConfig.ApiSite = "//api" + domainConfig.TopDomain;//"http://api.tuhu.dev";  //
    //domainConfig.ApiSite = "http://api.unit.tuhu.cn/";
    ...
    var $resource = {
        getProducts: function () {
            ...
            return $.ajax({
                ...
                data: { userID: userID, phone: phone, actid: urlParams['actid'] },
                dataType: 'jsonp'
...
//http://t.tuhu.cn/act?tm=ww&cp=112&uid=222&pids=12&c_id=ppdfiodko
//统计页面被访问
var Uuid = "";
