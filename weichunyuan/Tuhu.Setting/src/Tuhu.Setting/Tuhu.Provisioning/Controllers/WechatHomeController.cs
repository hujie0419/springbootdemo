    ...
    public class WechatHomeController : Controller
    {
        ...
        public ActionResult GetWeChatOfficialAccounts(int type = 0)
        {
            using (var client = new WeiXinPushClient())
            {
                ...
                return Content(JsonConvert.SerializeObject(accounts.Where(t => (type == 0 ? t.Type == "WX_Open" : t.Type == "WX_APP")  && !string.IsNullOrWhiteSpace(t.channel)).Select(t => new { t.OriginalId, t.name ,t.channel})));
            }
        }
