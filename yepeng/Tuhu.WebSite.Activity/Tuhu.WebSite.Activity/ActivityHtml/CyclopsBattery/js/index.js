...
$(function () {
    ...
    Login();
    //SelectCarObject('{acc71c21-28cd-5ead-da9d-d94af0d69f44}');
    //GetBatteryList(13580); 
    //GetBatteryList(575);
});
...
function NoneFooter() {
    ...
    $(".view-more").css({
        "text-align": "center", "margin-top": "0%", "display": "block"
    });
...
function NoneFooterForOld() {
    ...
    $(".foot").css("display", "none");
    $(".view-more").css({
        "text-align": "center", "margin-top": "0%", "display": "block", "color": "red"
    });
    $("#province-ul").css("display", "none");
    $(".progress").hide();
    $(".notice-bg").hide();
...
function PayClick() {
    ...
    if (!$(this).hasClass("disabled") && !($(".areaSelect>li").eq(1).find(".selectItem").children(".default").text() == "城市/地区、自治州")) {
        if ($(".p-price").text() != "" && $(".p-price").text() != null) {
            ...
            window.location.href = "http://faxian.tuhu.cn/ActivityHtml/CyclopsBattery/Order.html?RegionSelect=" + selectRegions + "&v=7";
