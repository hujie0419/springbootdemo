...
namespace Tuhu.Provisioning.Business.Tire
{
    public class RecommendManager
    {
       ...
       public static string GetMatchBySize(string matchTires, string tireSize)
        ...
        public static IEnumerable<RecommendProductModel> SelectQZTJByPID(string PID) => DALRecommendTire.SelectQZTJByPID(PID);
        public static IEnumerable<RecommendProductModel> SelectQZTJByPIDs(string PIDs) => DALRecommendTire.SelectQZTJByPIDs(PIDs);
