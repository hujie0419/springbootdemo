    ...
    public static class HtmlExtension
    {
        ...
        public static MvcHtmlString Pager(this HtmlHelper helper, PagerModel pager, Func<int, string> func)
        {
            ...
            if (pager.CurrentPage < 2)
                ...
                sb.Append("<a class=\"first-child\" data-page=\""+ (pager.CurrentPage - 1) + "\" href=\"" + func(pager.CurrentPage - 1) + "\">&lt;&lt; 上一页</a>");
            if (pager.TotalPage < 12)
            {
                for (var index = 1; index <= pager.TotalPage; index++)
                {
                    if (index == pager.CurrentPage)
                        ...
                        sb.AppendFormat("<a href=\"{0}\" data-page=\"{1}\">{1}</a>", func(index), index);
                }
            }
            else
            {
                if (pager.CurrentPage < 8)
                {
                    ...
                    sb.Append("<span>...</span>");
                    sb.AppendFormat("<a href=\"{0}\" data-page=\"{1}\">{1}</a>", func(pager.TotalPage - 1), pager.TotalPage - 1);
                    sb.AppendFormat("<a href=\"{0}\" data-page=\"{1}\">{1}</a>", func(pager.TotalPage), pager.TotalPage);
                }
                else if (pager.CurrentPage > pager.TotalPage - 7)
                {
                    sb.Append("<a href=\"" + func(1) + "\" data-page=\"1\">1</a>");
                    sb.Append("<a href=\"" + func(2) + "\" data-page=\"2\">2</a>");
                    sb.Append("<span>...</span>");
                    for (var index = pager.TotalPage - 7; index <= pager.TotalPage; index++)
                    {
                        if (index == pager.CurrentPage)
                            sb.Append("<a class=\"current\" data-page=\"{1}\">" + index + "</a>");
                        else
                            sb.AppendFormat("<a href=\"{0}\" data-page=\"{1}\">{1}</a>", func(index), index);
                    }
                }
                else
                {
                    ...
                    sb.Append("<span>...</span>");
                    sb.AppendFormat("<a data-page=\"{1}\" href=\"{0}\">{1}</a>", func(pager.TotalPage - 1), pager.TotalPage - 1);
                    sb.AppendFormat("<a data-page=\"{1}\" href=\"{0}\">{1}</a>", func(pager.TotalPage), pager.TotalPage);
                }
            }
            if (pager.CurrentPage >= pager.TotalPage)
                sb.Append("<a class=\"disabled last-child\">下一页 &gt;&gt;</a>");
            else
                sb.Append("<a class=\"last-child\" data-page=\""+ (pager.CurrentPage + 1) + "\" href=\"" + func(pager.CurrentPage + 1) + "\">下一页 &gt;&gt;</a>");
            sb.Append("</div>");
