...
namespace Tuhu.Provisioning.Areas.BigBrand.Controllers
{
    public class BigBrandPoolController : Controller
    {
        ...
        public ActionResult GetGridPageStyleJson(int keyValue, Guid? groupGuid)
        {
            List<BigBrandPageStyleEntity> list = null;
            if (groupGuid.HasValue)
            {
                RepositoryManager manager = new RepositoryManager();
                Expression<Func<BigBrandPageStyleEntity, bool>> exp = _ => _.FKPKID == keyValue && _.GroupGuid == groupGuid;
        ...
        public ActionResult GetGridPageStyleJson2(int keyValue, Guid? groupGuid)
        {
            List<BigBrandPageStyleEntity> list = null;
            if (groupGuid.HasValue)
            {
        ...
        public ActionResult DeletePageStyle(int keyValue, Guid groupGuid)
        {
            RepositoryManager manager = new RepositoryManager();
            Expression<Func<BigBrandPageStyleEntity, bool>> exp = _ => _.FKPKID == keyValue && _.GroupGuid == groupGuid;
