...
K.options = {
	...
	items : [
		...
		'justifyfull', 'insertorderedlist', 'insertunorderedlist','removeformat', '|', 'image', 'multiimage','addvideo','hr',
		'link', 'unlink', '|', 'addproduct', 'bigtitle', 'smalltitle', 'addquote', '|', 'preview', 'fullscreen'
	],
...
_extend(KCmd, {
	...
	insertimage : function(url, title, width, height, border, align) {
		...
		var html = '<div style="text-align: center;margin:10px 0 "><img src="' + _escape(url) + '" data-ke-src="' + _escape(url) + '" ';
		if (width) {
