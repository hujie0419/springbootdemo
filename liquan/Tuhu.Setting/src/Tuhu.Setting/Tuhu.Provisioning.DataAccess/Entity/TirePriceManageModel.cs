...
namespace Tuhu.Provisioning.DataAccess.Entity
{
    ...
    public class TireListModel
    {
        ...
        public decimal? JDJYPrice { get; set; }

        public string JDJYPID { get; set; }

        public decimal? JDFWPrice { get; set; }
        /// <summary>
        /// 市场价格
        /// </summary>
        public decimal?  MarketingPrice { get; set; }
        public string JDFWPID { get; set; }
        ...
        /// 天猫养车零配件官方直营
        /// </summary>
        public decimal? TMLPJPrice { get; set; }

        public string TMLPJId { get; set; }
    }
