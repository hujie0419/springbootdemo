...
{
    /// <summary>
    /// TOP API: alibaba.scm.external.wms.item.update
    /// </summary>
    public class AlibabaScmExternalWmsItemUpdateRequest : BaseTopRequest<Top.Api.Response.AlibabaScmExternalWmsItemUpdateResponse>
    {
        /// <summary>
        /// 保质期临期天数
        /// </summary>
        ...
        {
            return "alibaba.scm.external.wms.item.update";
        }
