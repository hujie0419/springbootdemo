...
export default {
    ...
    methods: {
        ...
        toedit (day) {
            debugger;
            this.$router.push({ 'name': 'seckillEdit', query: { activityId: day.ActivityId, schedule: day.Schedule, shortDate: day.ShortDate, isDefault: day.IsDefault, strStatus: day.StrStatus } });
        },
        getclass (state) {
            switch (state) {
                case 1:
                ...
                case 3:
                    return { "background-color": "paleturquoise", "color": "black", "text-align": "center", "line-height": "45px" };
                case 4:
                    return { "background-color": "yellow", "color": "red", "text-align": "center", "line-height": "45px" };
                case 5:
                    return { "background-color": "paleturquoise", "color": "black", "font-weight": "bold", "text-align": "center", "line-height": "45px" }
                case 6:
        ...
        getclass2 (state) {
            switch (state) {
                case 5:
                    return { "background-color": "paleturquoise", "color": "red", "text-align": "center", "line-height": "45px" }
                case 6:
