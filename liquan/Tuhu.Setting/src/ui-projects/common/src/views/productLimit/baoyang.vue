    ...
    <div class="content-wrapper ivu-layout-content">
        <Form>
            ...
            <FormItem label="限购数量">
                ...
                <!-- 数字输入框 -->
                <Label @click="handleShowCategoryLog()" style="margin-left:10px"><a href="javascript:;">操作日志</a></Label>
            </FormItem>
            <FormItem>
...
export default {
    ...
    methods: {
        getLimitCount() {
            var param = "name=保养&code=BaoYang&level=1";
            this.ajax
                .get("/ProductLimitBaoYang/FetchCategoryLimitCount?" + param)
                .then(res => {
                    if (res.data.success) {
        ...
        handleSubmit() {
            ...
            this.ajax
                .post("/ProductLimitBaoYang/SaveCategoryLimitCount", {
                    CategoryCode: "BaoYang",
                    CategoryName: "保养",
                    CategoryLevel: 1,
        ...
        handleShowCategoryLog() {
            ...
            this.util.ajax
                .post(`/ProductLimitBaoYang/GetCommonConfigLogs`, {
                    category: "BaoYang",
                    level: 1
                })
                .then(res => {
        ...
        refreshCache() {
            this.util.ajax
                .post("/ProductLimitBaoYang/RefreshCache")
                .then(res => {
                    if (res.data.success) {
