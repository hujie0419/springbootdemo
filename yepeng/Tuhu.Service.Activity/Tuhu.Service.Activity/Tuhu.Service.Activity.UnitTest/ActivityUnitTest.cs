    ...
    public class ActivityUnitTest
    {
        ...
        public void GetOrSetActivityPageSortedPidsAsync()
        {
            using (var client = new ActivityClient())
            {
                ...
                {
                   //Brand= "3M",
                   DicActivityId = new KeyValuePair<string, ActivityIdType>("d423aa35-8164-475e-a751-00a67acb5a66", ActivityIdType.FlashSaleActivity),
...
=======
        [TestMethod]
        public void TestDeleteActivityModelByActivityId1()
        {
            using (var client = new ActivityClient())
            {
                var result = client.DeleteActivityModelByActivityId(new Guid("95bdc442-6a48-4bc1-8224-1ee8d22be5a6"));
                Assert.IsTrue(result.Result);
            }
        }

        [TestMethod]
        public async Task TestGetUserApplyActivityRangeByScoreAsync()
        {
            using (var client = new ActivityClient())
            {
        ...
        [TestMethod]
        public async Task TestGetUserApplyActivitySortedSetLengthAsync()
        {
            using (var client = new ActivityClient())
            {
                var result = await client.GetUserApplyActivitySortedSetLengthAsync();
                Assert.IsTrue(result.Success);
            }
        }

        [TestMethod]
        public async Task TestRemoveOneUserApplyActivitySortedSetCacheAsync()
        {
            using (var client = new ActivityClient())
            {
                var result1 = await client.GetUserApplyActivityRangeByScoreAsync();
                var result = await client.RemoveOneUserApplyActivitySortedSetCacheAsync(result1.Result.First());
                Assert.IsTrue(result.Success);
            }
        }

        [TestMethod]
        public async Task TestGetActivityModelsPaged()
        {
            using (var client = new ActivityClient())
            {
                var result = await client.GetActivityModelsPagedAsync(1, 10);
                Assert.IsTrue(result.Success);
            }
        }

        [TestMethod]
        public void TestGetActivityModelByActivityId()
        {
            using (var client = new ActivityClient())
            {
                var result = client.GetActivityModelByActivityId(new Guid("95bdc442-6a48-4bc1-8224-1ee8d22be5a6"));
                Assert.IsTrue(result.Success);
            }
        }

        [TestMethod]
        public void TestInsertActivityModel()
        {
            using (var client = new ActivityClient())
            {
                var model=new ActivityNewModel
                {
                    ActivityId = Guid.NewGuid(),
                    Name="test",
                    StartTime = DateTime.Now.AddDays(1),
                    EndTime = DateTime.Now.AddDays(3),
                    ActivityType = ActivityType.FreeWashingCar,
                ...
                var result = client.InsertActivityModel(model);
                Assert.IsTrue(result.Success);
            }
        }

        [TestMethod]
        public void TestUpdateActivityModel()
        {
            using (var client = new ActivityClient())
            {
                var model = new ActivityNewModel
                ...
                var result = client.UpdateActivityModel(model);
                Assert.IsTrue(result.Success);
            }
        }

        [TestMethod]
        public void TestDeleteActivityModelByActivityId()
        {
            using (var client = new ActivityClient())
            {
                var result = client.DeleteActivityModelByActivityId(new Guid("95bdc442-6a48-4bc1-8224-1ee8d22be5a6"));
        ...
        [TestMethod]
        public void TestInsertUserActivityModel()
        {
            using (var client = new ActivityClient())
            {
                var model = new UserApplyActivityModel
                {
                    UserId = Guid.NewGuid(),
                    ActivityId = Guid.NewGuid(),
                    UserName = "testUser",
                    Mobile = "18621972473",
                    CarNum = "沪A12345",
                    DriverNum = "31011219930211181X",
                    Status = AuditStatus.Pending,
                    CreatedDateTime = DateTime.Now,
                    UpdatedDateTime = DateTime.Now
                };
                var result = client.InsertUserActivityModel(model);
                Assert.IsTrue(result.Success);
            }
        }

        [TestMethod]
        public void TestUpdateUserActivityStatusByPKID()
        {
            using (var client = new ActivityClient())
            {
                var model=new UserApplyActivityModel
                ...
                var result = client.UpdateUserActivityStatusByPKID(model);
                Assert.IsTrue(result.Success);
            }
        }

        [TestMethod]
        public void TestGetUserApplyActivityModelsPaged()
        {
            using (var client = new ActivityClient())
            {
                var result = client.GetUserApplyActivityModelsPaged(new Guid("95bdc442-6a48-4bc1-8224-1ee8d22be5a6"),
                    AuditStatus.Passed, 1, 10);
                Assert.IsTrue(result.Success);
            }
        }

        [TestMethod]
        public void TestGetActivityApplyUserCountByActivityId()
        {
            using (var client = new ActivityClient())
            {
                var result =
                    client.GetActivityApplyUserCountByActivityId(new Guid("95bdc442-6a48-4bc1-8224-1ee8d22be5a6"));
                Assert.IsTrue(result.Success);
            }
        }

        [TestMethod]
        public async Task TestGetActivityApplyUserPassCountByActivityIdAsync()
        {
            using (var client = new ActivityClient())
            {
                var result =
                    await client.GetActivityApplyUserPassCountByActivityIdAsync(new Guid("a6a03f47-525d-4486-8675-9207685d0d94"));
                Assert.IsTrue(result.Success);
            }
        }
        [TestMethod]
        public void TestGetUserApplyActivityByPKID()
        {
            using (var client = new ActivityClient())
            {
                var result = client.GetUserApplyActivityByPKID(10);
                Assert.IsTrue(result.Success);
            }
        }

        [TestMethod]
        public void TestDeleteUserApplyActivityModelByPKID()
        {
            using (var client = new ActivityClient())
            {
                var result = client.DeleteUserApplyActivityModelByPKID(10);
                Assert.IsTrue(result.Success);
            }
        }

        [TestMethod]
        public void TestCheckUserApplyActivityInfoIsExist()
        {
            using (var client = new ActivityClient())
            {
                var result = client.CheckUserApplyActivityInfoIsExist(new Guid("95bdc442-6a48-4bc1-8224-1ee8d22be5a6"),
                    "18621972473", "沪A12345", "31011219930211181X");
                Assert.IsTrue(result.Success);
            }
        }

        [TestMethod]
        public void TestRefreshActivityModelByActivityIdCache()
        {
            using (var client = new ActivityClient())
            {
                var result =
                    client.RefreshActivityModelByActivityIdCache(new Guid("95bdc442-6a48-4bc1-8224-1ee8d22be5a6"));
                Assert.IsTrue(result.Success);
            }
        }

        [TestMethod]
        public void TestRemoveActivityModelByActivityIdCache()
        {
            using (var client = new ActivityClient())
            {
                var result =
                    client.RemoveActivityModelByActivityIdCache(new Guid("95bdc442-6a48-4bc1-8224-1ee8d22be5a6"));
                Assert.IsTrue(result.Success);
            }
        }
