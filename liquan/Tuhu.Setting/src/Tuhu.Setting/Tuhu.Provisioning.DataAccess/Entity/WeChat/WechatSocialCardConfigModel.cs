...
namespace Tuhu.Provisioning.DataAccess.Entity.WeChat
{
	...
	public class WechatSocialCardConfigModel
    {
        ...
        /// </summary>
        [Required]
        public string CreateMidName { get; set; }

        /// <summary>
        /// 适用商家商户号列表
        /// </summary>
        [Required]
        public string UseMids { get; set; }

        /// <summary>
        /// 适用商家商户号列表
        /// </summary>
        [Required]
        public List<string> UseMidList { get; set; }
        ...
        /// </summary>
        [Required]
        public List<string> UseMidNameList { get; set; }
    ...
    public class WechatSocialActivityConfigModel
    {
        ...
        /// 商户号 显示名称
        /// </summary>
        public string MerchantNoName { get; set; }
