...
namespace Tuhu.Provisioning.Business
{
    ...
    public class SE_GiftManageConfigBLL
    {
        ...
        private static readonly Common.Logging.ILog logger = LogManager.GetLogger<SE_GiftManageConfigBLL>();
        ...
        /// 获取支付方式渠道集合
        /// </summary>
        public static IEnumerable<DataAccess.Entity.ChannelDictionariesModel> GetU_ChannelPayList()
        {
            try
            {
        ...
        /// <returns></returns>
        public static bool BatchUpdateTime(IEnumerable<SE_GiftManageConfigModel> modules)
        {
            using (var connection = ProcessConnection.OpenGungnir)
            {
                return new SE_GiftManageConfigDAL().BatchUpdateTime(connection, modules);
            }
        }
    }
}
