...
namespace Tuhu.Provisioning.DataAccess.Entity.SalePromotionActivity
{
    ...
    public static class SalePromotionActivityConst
    {
        ...
        public const string SetProductImage = "SalePromotion_SetProductImage"; //修改商品列表牛皮癣 
        public const string SetProductDetailImage = "SalePromotion_SetProductDetailImage"; //修改商品详情页牛皮癣 
