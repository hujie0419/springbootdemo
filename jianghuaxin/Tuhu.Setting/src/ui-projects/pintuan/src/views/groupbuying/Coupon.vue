        ...
        <Form ref="modal.productConfig" :model="modal.productConfig" :rules="modal.rules" :label-width="90">
            ...
            <FormItem v-for="(item, index) in modal.productConfig.Coupons" :label="'优惠券-'+(index+1)" :key="index" :prop="'executors.' + index">
                <Row>
                    ...
                    <input style="display:inline-block;width:200px;height:30px;margin-right:10px"  type="text" :disabled="!item.AllowEdit" :key="index" @blur="FetchCouponInfo(item.CouponId,index)" v-model="item.CouponId" placeholder="优惠券PID" />
                    ...
                    <label style="display:inline-block;width:100px;font-size: 10px;" v-if="couponType=='value'" >优惠券价格</label>
