...
namespace MarketplaceWebServiceOrders
{
	...
	public class MarketplaceWebServiceOrdersSample
	{
		...
		public static void Main(string[] args)
		{
			...
			string accessKey = "AKIAJY52LJAIB24SRRLQ";

			// Developer AWS secret key
			string secretKey = "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";

			// The client application name
			string appName = "AAHKV2X7AFYLW";
			...
			string serviceURL = "https://mws.amazonservices.com.cn";
		...
		public GetOrderResponse InvokeGetOrder()
		{
			...
			string sellerId = "A247BH444DALA8";
		...
		public ListOrdersResponse InvokeListOrders()
		{
			...
			request.SellerId = "A247BH444DALA8";
			request.LastUpdatedAfter = DateTime.Now.AddDays(-15);
			request.MarketplaceId = new List<string>() { "AAHKV2X7AFYLW" };
