...
namespace Tuhu.Service.Activity.Server
{
    public class ActivityService : IActivityService
    {
        ...
        public Task<OperationResult<Tuple<IEnumerable<ActivityNewModel>, int>>> GetActivityModelsPagedAsync(int pageIndex, int pageSize)
        {
            return ActivityManager.GetActivityModelsPagedAsync(pageIndex, pageSize);
        }

        public Task<OperationResult<ActivityNewModel>> GetActivityModelByActivityIdAsync(Guid activityId)
        {
            return ActivityManager.GetActivityModelByActivityIdAsync(activityId);
        }
        ...
        public Task<OperationResult<bool>> DeleteActivityModelByActivityIdAsync(Guid activityId)
        {
            return ActivityManager.DeleteActivityModelByActivityIdAsync(activityId);
        }
        ...
        public Task<OperationResult<Tuple<IEnumerable<UserApplyActivityModel>, int>>> GetUserApplyActivityModelsPagedAsync(Guid activityId, AuditStatus auditStatus, int pageIndex, int pageSize)
        {
            return ActivityManager.GetUserApplyActivityModelsPagedAsync(activityId, auditStatus, pageIndex, pageSize);
        }

        public Task<OperationResult<int>> GetActivityApplyUserCountByActivityIdAsync(Guid activityId)
        {
            return ActivityManager.GetActivityApplyUserCountByActivityIdAsync(activityId);
        }

        public Task<OperationResult<int>> GetActivityApplyUserPassCountByActivityIdAsync(Guid activityId)
        {
            return ActivityManager.GetActivityApplyUserPassCountByActivityIdAsync(activityId);
        }

        public Task<OperationResult<UserApplyActivityModel>> GetUserApplyActivityByPKIDAsync(int pkid)
        {
            return ActivityManager.GetUserApplyActivityByPKIDAsync(pkid);
        }

        public Task<OperationResult<bool>> DeleteUserApplyActivityModelByPKIDAsync(int pkid)
        {
            return ActivityManager.DeleteUserApplyActivityModelByPKIDAsync(pkid);
        }

        public Task<OperationResult<bool>> CheckUserApplyActivityInfoIsExistAsync(Guid activityId, string mobile, string carNum, string driverNum)
        {
            return ActivityManager.CheckUserApplyActivityInfoIsExistAsync(activityId, mobile, carNum, driverNum);
        }

        public Task<OperationResult<bool>> RefreshActivityModelByActivityIdCacheAsync(Guid activityId)
        {
            return ActivityManager.SetActivityModelByActivityIdCacheAsync(activityId);
        }

        public Task<OperationResult<bool>> RemoveActivityModelByActivityIdCacheAsync(Guid activityId)
        {
            return ActivityManager.RemoveActivityModelByActivityIdCacheAsync(activityId);
        }

        public Task<OperationResult<bool>> AddUserApplyActivitySortedSetCacheAsync(UserApplyActivityModel userApplyActivityModel)
        {
            return ActivityManager.AddUserApplyActivitySortedSetCacheAsync(userApplyActivityModel);
        }

        public Task<OperationResult<IEnumerable<UserApplyActivityModel>>> GetUserApplyActivityRangeByScoreAsync()
        {
            return ActivityManager.GetUserApplyActivityRangeByScoreAsync();
        }

        public Task<OperationResult<long>> GetUserApplyActivitySortedSetLengthAsync()
        {
            return ActivityManager.GetUserApplyActivitySortedSetLengthAsync();
        }
