...
VALUES  ( @Name , -- Name - nvarchar(50)
        ...
        /// <param name="model"></param>
        /// <param name="pkid"></param>
        public int AddHomePageContent(SqlConnection connection, SE_HomePageModuleContentConfig model, int pkid)
        {
            string sql = @"
                     DECLARE @InseredTable TABLE (
                    ID INT 
        ...
        /// <param name="pkid"></param>
        /// <returns></returns>
        public bool UpdateHomePageContent(SqlConnection connection, SE_HomePageModuleContentConfig model, int pkid)
        {
        ...
        /// <param name="pkid"></param>
        /// <returns></returns>
        public bool DeleteHomePageContent(SqlConnection connection, int id, int pkid)
        {
