...
{
	public class OrderSearchResponse : QplResponse
	{
		private int code = 999;

		public CustomerOrderModel[] Orders { get; private set; }
		...
		public override string Body
		{
			...
			internal set
			{
				...
				try
				{
					...
					Orders = json.Value<JToken>("order_list").ToObject<CustomerOrderModel[]>();
				}
				catch (Exception ex)
				{
					code = 999;
