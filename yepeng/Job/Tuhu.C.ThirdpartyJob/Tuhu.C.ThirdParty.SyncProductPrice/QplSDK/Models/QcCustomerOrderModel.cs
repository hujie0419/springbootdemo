...
namespace Qpl.Api.Models
{
    ...
    /// 订单模型
    /// </summary>
    public class QcCustomerOrderModel
    {
        [Key]
        ...
        /// 订单明细信息
        /// </summary>
        public List<QcCustomerOrderItemModel> OrderItems { get; set; }
        ...
        public QcCustomerOrderModel DeepCopy()
        {
            return (QcCustomerOrderModel)MemberwiseClone();
        }
    }
}
