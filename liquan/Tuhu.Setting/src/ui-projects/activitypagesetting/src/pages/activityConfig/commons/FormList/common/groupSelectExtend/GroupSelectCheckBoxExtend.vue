...
export default {
    ...
    watch: {
        ...
        isCheckValue(nowVal) {
            ...
            let mValue = this.getMValue();
            if (mValue && mValue.select !== nowValue) {
             ...
             * 校正myValue
             */
            if (!nowVal && myValue && myValue.select === nowValue) {
                this.setItemValue(null);
                this.resetTextValue(null);// 切换状态的时候清空内容
            }
        },
        /**
         * 监听输入内容发生改变
