...
{
    public class TiresActivityResponse
    {
        /// <summary>
        /// 活动ID
        /// </summary>
        ...
        /// 楼层活动配置
        /// </summary>
        public List<TiresFloorActivityConfig> TiresFloorActivity { get; set; }
    }
    ...
    public class TiresFloorActivityConfig
    {
        ...
        /// 图片对应产品
        /// </summary>
        public IEnumerable<ImgAndProductMap> OtherImgAndProductMap { get; set; }
    }
}
