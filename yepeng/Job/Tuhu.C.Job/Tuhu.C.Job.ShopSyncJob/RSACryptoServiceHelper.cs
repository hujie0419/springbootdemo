...
namespace Tuhu.C.Job.ShopSyncJob
{
    public class RSACryptoServiceHelper
    {
        public static string PublicKey
        {
            get
            {
                return AppDomain.CurrentDomain.BaseDirectory + "/Keys/alipay_rsa_public_key.pem";
            }
        }
        public static string AliPayPublicKey
        {
            get
            {
                return AppDomain.CurrentDomain.BaseDirectory + "/Keys/alipay_rsa_public_key_ap.pem";
            }
        }
        public static string PrivateKey
        {
            get
            {
                return AppDomain.CurrentDomain.BaseDirectory + "/Keys/alipay_rsa_private_key.pem";
            }
        }
        ...
        /// <returns></returns>
        public static string GetSignDataContent(IDictionary<string, string> parameters, bool IgnoreEmptyValue = false)
        {
        ...
        /// <param name="parameters"></param>
        /// <returns></returns>
        public static string SignData(IDictionary<string, string> parameters)
        {
            string content = GetSignDataContent(parameters);
