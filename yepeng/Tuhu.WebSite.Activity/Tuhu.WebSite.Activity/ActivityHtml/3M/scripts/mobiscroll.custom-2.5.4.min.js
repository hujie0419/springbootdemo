(function(a) {
	function u(i, b) {
		...
		o.show = function(i) {
			...
			c += ("inline" != n.display ? '<div class="dwbc' + (n.button3 ? " dwbc-p" : "") + '"><span class="dwbw dwb-c"><span class="dwb">' + n.cancelText + "</span></span>" + (n.button3 ? '<span class="dwbw dwb-n"><span class="dwb">' + n.button3Text + "</span></span>" : "") + '<span class="dwbw dwb-s"><span class="dwb">' + n.setText + "</span></span></div></div>" : '<div class="dwcc"></div>') + "</div></div></div>";
			B = a(c);
			m();
			J("onMarkupReady", [B]);
