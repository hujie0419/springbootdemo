...
namespace Tuhu.Service.Activity.Server.Manager
{
    public static class ActivityManager
    {
        ...
        private static async Task<IEnumerable<SimpleProductModel>> SelectSimpleProductModels(string hashKey, List<string> pids)
        {
            try
            {
                return await TuhuMemoryCache.Instance.GetOrSetAsync($"LocalSimpleProducts{hashKey}", async () =>
          {
...
(1, "成功"), cacheresult.Value.OrderBy(v => v.Value).Select(key => key.Key).ToList());
        ...
        /// <returns></returns>
        public static async Task<bool> AddEnrollInfo(TEnrollInfoModel infomodel)
        {
            var result = await DalActivity.AddEnrollInfo(infomodel);
            return result > 0;
        }
        ...
        /// <param name="infomodel"></param>
        /// <returns></returns>
        public static async Task<bool> UpdateEnrollInfo(TEnrollInfoModel infomodel)
        {
            var result = await DalActivity.UpdateEnrollInfo(infomodel);
            return result > 0;
        }
        ...
        /// <returns></returns>
        public static async Task<bool> UpdateUserEnrollStatus(string area)
        {
            var result = await DalActivity.UpdateUserEnrollStatus(area);
            return result > 0;
        }
        ...
        /// <returns></returns>
        public static async Task<TEnrollInfoModel> GetEnrollInfoModelByTel(string tel)
        {
            var result = await DalActivity.GetEnrollInfoModelByTel(tel);
            return result;
        }
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public static async Task<TEnrollInfoModel> GetEnrollInfoModel(int id)
        {
            var result = await DalActivity.GetEnrollInfoModel(id);
            return result;
        }
        ...
        /// <param name="area"></param>
        /// <returns></returns>
        public static async Task<PagedModel<TEnrollInfoModel>> SelectEnrollInfoByArea(string area, int pageIndex = 1, int pageSize = 20)
        {
            var result = await DalActivity.SelectEnrollInfoByArea(area,pageIndex, pageSize);
            return result;
        }
