    ...
    public class GFTaskCreator
    {
        ...
        public async Task CreateCardRecordAndTask()
        {
            ...
            else
            {
                ...
                EmailHelper.SendEmail($"广发联名卡Job异常", $"根据广发数据创建用户失败,{this.ToString}");
            }
        }
        /// <summary>
        ...
        private async Task CreatePromotionTask()
        {
            ...
            foreach (var rule in ruleGuids)
            {
                ...
                if (!insertTaskResult)
                {
                    ...
                    EmailHelper.SendEmail("广发联名卡Job异常", $"创建发券任务失败,{this.ToString}");
                }
            }
        }
        /// <summary>
        ...
        private async Task CreateRedemptionCodeTask()
        {
            ...
            if (!insertTaskResult)
            {
                ...
                EmailHelper.SendEmail("广发联名卡Job异常", $"创建兑换码任务失败,{this.ToString}");
            }
        }
