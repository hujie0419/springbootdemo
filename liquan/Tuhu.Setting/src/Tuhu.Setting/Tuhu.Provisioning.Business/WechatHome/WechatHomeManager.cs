...
namespace Tuhu.Provisioning.Business.WechatHome
{
    public class WechatHomeManager
    {
        ...
        private static readonly Common.Logging.ILog Logger= Common.Logging.LogManager.GetLogger(typeof(WechatHomeManager));
        ...
        public bool DeleteContentByFKID(int fkid)
        {
            using (var conn = ProcessConnection.OpenConfiguration)
            {
                return dal.DeleteContentByFKID(conn, fkid);
            }
        }

        public bool DeleteProductContentByFKID(int fkid)
        {
            using (var conn = ProcessConnection.OpenConfiguration)
            {
                return dal.DeleteProductContentByFKID(conn, fkid);
            }
        }
        ...
        public WXOARedEnvelopeSettingModel GetOARedEnvelopeSettingModel()
        {
            try
            {
                return dal.GetOARedEnvelopeSettingModel();
            }
            catch (Exception ex)
            {
                Logger.Error("GetOARedEnvelopeSettingModel", ex);
                throw ex;
            }
        }
        ...
        public WXOARedEnvelopeSettingModel GetOARedEnvelopeActivityTime()
        {
            try
            {
                return dal.GetOARedEnvelopeActivityTime();
            }
            catch (Exception ex)
            {
                Logger.Error("GetOARedEnvelopeActivityTime", ex);
                throw ex;
            }
        }
        #endregion
        ...
        public List<WXOARedEnvelopeStatisticsModel> GetOARedEnvelopeStatisticsList(Pagination pagination, string startTime, string endTime)
        {
            try
            {
                var result = dal.GetOARedEnvelopeStatisticsList(pagination,startTime,endTime);
                return result;
            }
            catch (Exception ex)
            {
                Logger.Error("GetOARedEnvelopeStatisticsList", ex);
                throw ex;
            }
        }
        ...
        public List<WXOARedEnvelopeStatisticsModel> GetOARedEnvelopeStatisticsListByTime(string startTime, string endTime)
        {
            try
            {
                var result = dal.GetOARedEnvelopeStatisticsListByTime(startTime, endTime);
                return result;
            }
            catch (Exception ex)
            {
                Logger.Error("GetOARedEnvelopeStatisticsListByTime", ex);
                throw ex;
            }
        }
        #endregion
