...
namespace Top.Api.Request
{
    ...
    public class WlbWaybillIProductRequest : BaseTopRequest<Top.Api.Response.WlbWaybillIProductResponse>
    {
        ...
        public WaybillProductTypeRequestDomain WaybillProductTypeRequest_ { set { this.WaybillProductTypeRequest = TopUtils.ObjectToJson(value); } } 
	...
	/// <summary>
/// WaybillProductTypeRequestDomain Data Structure.
/// </summary>
[Serializable]

public class WaybillProductTypeRequestDomain : TopObject
{
	        /// <summary>
	        /// 物流商编码CODE
	        /// </summary>
