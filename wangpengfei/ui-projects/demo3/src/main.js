...
util.ajax.get("/ipa/auth/GetBasicInformantion").then((response) => {
  if (response.data.success) {
    ...
    var host = location.hostname.replace("yunying", "setting");
    window.location.href = location.protocol + "//" + host + "/ipa/Home/LogOn?ReturnUrl=" + location.href;
  }
});
