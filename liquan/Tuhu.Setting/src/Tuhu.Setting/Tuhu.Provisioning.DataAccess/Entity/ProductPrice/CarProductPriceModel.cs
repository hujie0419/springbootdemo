...
namespace Tuhu.Provisioning.DataAccess.Entity.ProductPrice
{
    public class CarProductPriceModel
    {
        ...
        /// 全网活动是否可用券
        /// </summary>
        public bool IsFullNetUsePCode { get; set; }

        /// 全网抢购价
        /// </summary>
        public decimal FullNetActivityPrice { get; set; }
        ...
        /// 在途库存
        /// </summary>
        public ZaituStockModel ZaituStock { get; set; }

        /// <summary>
        /// 可用库存
        /// </summary>
        public AvailableStockModel AvailableStock { get; set; }
        ...
        /// 全网抢购价列表价格
        /// </summary>
        public List<ActivityPriceModel> FullNetActivityPriceList { get; set; }
