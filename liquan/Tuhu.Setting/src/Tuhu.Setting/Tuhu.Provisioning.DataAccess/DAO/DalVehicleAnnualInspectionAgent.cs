...
namespace Tuhu.Provisioning.DataAccess.DAO
{
    public class DalVehicleAnnualInspectionAgent
    {
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public static bool UpdateVehicleOnlineAnnualInspectionAgent(SqlConnection conn, VehicleAnnualInspectionAgentModel model)
        {
            #region Sql
            var sql = @"UPDATE  Configuration..VehicleAnnualInspectionAgent
                        SET     VenderShortName = @VenderShortName ,
        ...
        /// <param name="carNoPrefix"></param>
        /// <returns></returns>
        public static VehicleAnnualInspectionAgentModel GetAnnualOnlineInspectionAgent
            (SqlConnection conn, string servicePid, string province, string city,string village)
        {
            #region Sql
            var sql = @"SELECT  s.PKID ,
                                s.ServicePid ,
