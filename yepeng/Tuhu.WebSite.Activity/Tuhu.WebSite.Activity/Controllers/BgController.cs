...
//                var json = GetSelfDetailSql(aid, px.CachedUserInfo.openid).ToJson();
...
//        {
//            using (var ra = RedisAdapter.Create(this))
//            {
...
//                        else
//                        {
//                            //var fc = FriendCuts.Create(ra, foid, aid);
//                            //fc.AddCut(rlt);
//                            var sd = GetSelfDetailSql(aid, foid);
//                            ra.Set<SelfDetails>(foid, sd, aid);
//                        }
//                    }
...
//            using (var ra = RedisAdapter.Create(this))
//            {
//                var sd = ra.Get<SelfDetails>(soid, aid);
//                if (sd == null)
//                {
//                    var rlt = GetSelfDetailSql(aid, soid);
//                    return Json(rlt);
//                }
//                return Json(sd);
//            }
...
//            }
//        }
//        private static SelfDetails GetSelfDetailSql(int aid, string soid)
//        {
