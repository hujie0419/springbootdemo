...
namespace Tuhu.Provisioning.Controllers
{
    public class BeautyServicePackageController : Controller
    {
        ...
        [PowerManage]
        public ActionResult PackageDetail(int packageId, string packageType)
        {
        ...
        public async Task<ActionResult> SearchServiceCode(string serviceCode, string mobile, int pageIndex = 1, int pageSize = 1000)
        {
            ...
            if (result.Item1.Any())
            {
                ...
                if (shopDic.Any())
                    ...
                    {
                        if (!string.IsNullOrEmpty(f.VerifyShop))
        ...
        public ActionResult UpsertBeautyServicePackageDetail(BeautyServicePackageDetail packageDetail)
        {
            ...
            if (rawPackage != null && rawPackage.IsPackageCodeGenerated)
            {
                ...
                if (rawPackageDetail != null &&
                    (rawPackageDetail.ServiceCodeTypeId != packageDetail.ServiceCodeTypeId ||
        ...
        [PowerManage]
        [HttpPost]
        public ActionResult DeleteBeautyServicePackageDetail(int pkid)
        {
            var isSuccess = false;
            var msg = string.Empty;
        ...
        public ActionResult GetAllBeautyServiceCodeTypeConfig()
        {
            var result = BeautyServicePackageManager.SelectAllBeautyServiceCodeTypeConfig();
