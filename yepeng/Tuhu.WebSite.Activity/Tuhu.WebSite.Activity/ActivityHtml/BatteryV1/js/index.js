        ...
        success: function (data) {
            if (data.IsSuccess) {
                ...
                $.each(ProvinceList, function (k, v) {//动态迭代省份节点
                    ...
                    AreaProvinceCode += (k == 0 ? "<span class='closebtn'></span>" : "") + "<li onclick='SelectProvinceItem(\"" + v.Pid + "\",this);'  data-value='" + v.Pid + "' data-name='" + v.PName + "' >" + v.PName.substr(0, 8) + "<br/>" + v.PName.substr(8) + "</li>";
...
function SelectProvinceItem(Pid, CurrentElement) {
    ...
    $.each(CurrentCityList, function (k, v) {//迭代城市节点
        AreaCityCode += (k == 0 ? "<span class=''></span>" : "") + "<li onclick='SelectCityItem(\"" + v.Cid + "\",this);'  data-value='" + v.Cid + "' data-name='" + v.CName + "' >" + v.CName.substr(0, 8) + "<br/>" + v.CName.substr(8) + "</li>";
    });
