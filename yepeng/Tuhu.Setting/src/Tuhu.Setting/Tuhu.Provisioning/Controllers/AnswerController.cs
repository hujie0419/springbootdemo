...
namespace Tuhu.Provisioning.Controllers
{
    public class AnswerController : Controller
    {
        ...
        public ActionResult GetGridJson(Pagination pagination,int showEnabledType = -1 )
        {
            ...
            {
                list = db.GetEntityList<AnswerInfoListEntity>(pagination);
                
            }
            else
            {
                list = db.GetEntityList<AnswerInfoListEntity>((en) => en.IsEnabled == (showEnabledType == 1),
                    pagination);
            }
