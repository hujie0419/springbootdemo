...
namespace Tuhu.Service.Activity.Server.Config
{
    public class GlobalConstant
    {
        ...
        public static string FlashSaleProductPagerCacheKeyPrefix = "FlashSaleProductPagerV1/";
        ...
        public static TimeSpan HomoSecKillTodayCacheExpiration = TimeSpan.FromMinutes(10);
        ...
        public static readonly string ActivityPagePrefix = "ActivityPagePrefix6";
        ...
        //砍价商品配置信息缓存key
        public static readonly string BargainProductSettingKey = "BargainProductSetting";
        //砍价商品详情图片缓存key
        public static readonly string BargainProductDescImgUrlKey = "BargainProductDescImgUrl";
        //砍价活动商品参与人数缓存key
        public static readonly string BargainProductParticipantCountKey = "BargainProductParticipantCount";
        ...
        /// CPS缓存Key
        /// </summary>
        public static string CommissionCacheName = "CommissionCacheName/";
        public static TimeSpan CommissionExpiration = TimeSpan.FromHours(2);
        ...
        ///     小游戏缓存头
        /// </summary>
        public const string GameCacheHeader = "GameCacheHeader";

        /// <summary>
        ///     小游戏缓存时间
        /// </summary>
        public static TimeSpan GameTimeSpan = TimeSpan.FromMinutes(5);

        #endregion
		
		//车友群
        public static readonly string CarFriendsGroupName = "CarFriendsGroup";
        public static readonly string CarFriendsGroupKey = "CarFriendsGroup/{0}";
        public static readonly string CarFriendsAdministratorKey = "CarFriendsAdministrator";
        public static readonly string CarFriendsAdministratorByPkidKey = "CarFriendsAdministrator/{0}";
        //车友群客服消息推送缓存
        public static readonly string CarFriendsGroupConsumerServiceKey = "CarFriendsGroupConsumerService/{0}";

        #region 锦鲤活动
        /// <summary>
        /// 锦鲤活动获取区
        /// a->Activity
        /// lch->LuckyCharmHeader 大驼峰首字母
        /// 长度尽量精简，key能一眼表达具体业务
        /// key中字符尽量全小写  并且以:进行拼接
        /// </summary>
        public static readonly string LuckyCharmHeader = "a:lch";
        /// <summary>
        /// 存储活动的详细信息
        /// 变量的结尾应该表名该KEY的存储类型
        /// </summary>
        public static readonly string LuckyCharmActivityKeyString = string.Concat(LuckyCharmHeader, ":activity:{0}");
        public static readonly string LuckyCharmActivityKeyHash = string.Concat(LuckyCharmHeader, ":activity");
        #endregion
    }
}
