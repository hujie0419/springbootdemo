...
{
    /// <summary>
    /// GetShareBargainProductInfo 获取砍价活动商品配置信息 接口返回参数
    /// </summary>
    public class GetShareBargainProductInfoResponse
    {
        ...
        /// 砍价商品详情页图片展示
        /// </summary>
        public List<BargainProductImg> ProductImgList { get; set; } = new List<BargainProductImg>();
    ...
    /// 砍价商品配置
    /// </summary>
    public class BargainProductImg
    {
