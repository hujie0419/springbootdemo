<template>
    <div>
        ...
        <div style="margin-top:18px">
            ...
            <lable style="margin-left:13px">活动状态：</lable>
            ...
            <lable style="margin-left:15px">团类型：</lable>
            ...
            <lable style="margin-left:20px">团种类：</lable>
        ...
        <div style="margin-top:18px">
            ...
            <lable style="margin-left:13px">是否显示：</lable>
            ...
            <lable style="margin-left:13px">显示顺序：</lable>
        ...
        <Modal v-model="tablemodal.visible" title="库存列表" cancelText="取消" @on-cancel="cancel" :height="300" scrollable="true" :width="tablemodal.width">
        ...
        <Modal v-model="productmodal.visible" title="商品价格信息确认" cancelText="取消" @on-cancel="cancel" @on-ok="ok(false)" scrollable="true" :width="productmodal.width">
            <Table :loading="productmodal.loading" :data="productmodal.data" :columns="productmodal.columns" stripe></Table>
        </Modal>
        <Modal v-model="modal.visible" :mask-closable="false" :loading="modal.loading" title="拼团产品配置（编辑）" okText="提交" :transfer="false" cancelText="取消" @on-ok="ok(true)" @on-cancel="cancel" scrollable="true" width="50%">
            <Form ref="modal.productConfig" :model="modal.productConfig" :rules="modal.rules" :label-width="90">
                <FormItem label="GroupId" prop="ProductGroupId">
                ...
                <FormItem label="特定人群" prop="SpecialUserTag">
                    <Input-Number v-model="modal.productConfig.SpecialUserTag" :max="100" :min="1" placeholder="待定人群" />
                </FormItem>
                <FormItem label="显示顺序" prop="Sequence">
                    <Input-Number v-model="modal.productConfig.Sequence" :max="10000000000" :min="0" placeholder="首页显示顺序" />
                </FormItem>
                <FormItem label="显示渠道" prop="Channel">
                ...
                <FormItem label="宣传图片" prop="Image">
                ...
                <FormItem label="分享文案" prop="ShareId">
                    <Input v-model="modal.productConfig.ShareId" placeholder="分享文案" />
                </FormItem>
                <FormItem label="抽奖规则描述" prop="GroupDescription">
                ...
                <FormItem v-for="(item, index) in modal.productConfig.GroupProductDetails" :label="'商品配置-'+(++index)" :key="index" :prop="'executors.' + index">
                    <Row>
                        <Col span="10">
            ...
            tablemodal: {
                ...
                columns: [
                    ...
                    },
                    {
                        title: "北京可用库存",
                        width: 100,
                        key: "BeiJingAvailableStockQuantity",
                        align: "center",
                        fixed: "left"
                    },
                    {
